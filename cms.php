					...
					<div class="main-event">
						<div class="evenementen">
							<div class="row" style="margin-bottom: 10px;">
								...
								<div class="col-md-10">
									<input type="text" class="form-control" id="evenement" aria-describedby="evenement" name="evenement" placeholder="Evenement">
								</div>

								<div class="col-md-6">
									<div class="form-check">
										<input class="form-check-input inlineCheckbox1" type="checkbox" value="Extra mensen" onClick="showInput()">
									...
									<div class="form-check">
										<input class="form-check-input inlineCheckbox2" type="checkbox" value="Vervoer" onClick="showInput2();">
									...
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="inlineCheckbox3" value="Vegetarisch">
										<label class="form-check-label" for="inlineCheckbox3">Vegetarich</label>
									</div>

									<div class="form-check">
										<input class="form-check-input inlineCheckbox4" type="checkbox" value="Edities" onClick="showInput3();">
								...
								<div class="col-md-6">
									<div class="form-check">
										<input class="form-check-input inlineCheckbox5" type="checkbox" value="Accomodatie" onClick="showInput4();">
									...
									<div class="form-check">
										<input class="form-check-input" type="checkbox" id="inlineCheckbox6" value="Annuleringsverzekering">
										<label class="form-check-label" for="inlineCheckbox6">Annuleringsverzekering</label>
									</div>

									<div class="form-check">
										<input class="form-check-input inlineCheckbox7" type="checkbox" value="Verhuur" onClick="showInput5();">
