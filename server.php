...
if ( isset( $_POST[ 'save' ] ) ) {
	...
	if ( isset($_POST['check7']) ) {
		...
		$sql = "INSERT INTO evenementen (evenement, datum_begin, datum_eind, prijs, max_deelnemers, extra_inschrijven, vervoer, vervoer_costs, vegetarisch,
		 editie, editie_costs, accomodatie, accomodatie_costs, annuleringsverzekering, verhuur, verhuur_costs)
		 VALUES ('$evenement', '$datum_begin', '$datum_eind', '$prijs', '$max_deelnemers', '$extra_inschrijven', '$vervoer', '$vervoer_costs', '$vegetarisch',
		  '$editie', '$editie_costs', '$accomodatie', '$accomodatie_costs', '$annuleringsverzekering', '$verhuur', '$verhuur_costs')";
